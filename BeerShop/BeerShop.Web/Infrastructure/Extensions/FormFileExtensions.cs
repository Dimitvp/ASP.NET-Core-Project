namespace BeerShop.Web.Infrastructure.Extensions
{
    ...
    public static class FormFileExtensions
    {
        ...
        public static string SaveImage(this IFormFile image, int productId, string productType, string imagePath)
        {
            var imageName = image.FileName.ToImageName(productId, productType);
